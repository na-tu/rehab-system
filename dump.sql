...
CREATE TABLE `rehab_records` (
  ...
  PRIMARY KEY (`id`),
  KEY `rehab_records_ibfk_1` (`patient_id`),
  CONSTRAINT `rehab_records_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patients` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2025-07-13 17:20:30
